...
BOT_TOKEN = getenv("BOT_TOKEN", "5538104001:AAEX75IyvYNBRz2mfT9rqNc3wXaHu2dVF8E")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1001854110934"))

# A name for your Music bot.
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Foox")
